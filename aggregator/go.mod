...
require (
	...
	github.com/grafana/loki v1.6.2-0.20251107203529-ffcd570f815c // v2.9.17 (loki's go.mod doesn't use semantic import versioning, so tags v2.x.y resolve as pseudo-versions)
...
require (
	...
	github.com/grafana/loki/pkg/push v0.0.0-20251107203529-ffcd570f815c // indirect
...
// Mirrored from github.com/grafana/loki's go.mod (v2.9.17) so our resolved
// dependency set matches what Loki itself is tested against.
