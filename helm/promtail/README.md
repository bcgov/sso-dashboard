...
* Installs the agent which ships the contents of local logs to a Loki instance [Promtail](https://grafana.com/docs/loki/latest/clients/promtail/)

## Installing/upgrading the Chart

To install/upgrade the chart with the release name `sso-promtail`:
...
* see https://github.com/grafana/helm-charts/tree/main/charts/promtail for more detail
